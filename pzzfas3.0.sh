...
function N03() {                                                                                ##########
                                                                             yum install php70w-cli php70w-mysqlnd phpw70-pdo
...
function web() {
rm -rf /var/www/* && cd /var/www && wget -q https://zheng147.github.io/vpnlk-fas/fas_web.zip
...
host=https://zheng147.github.io/vpnlk-fas/
logo
}
main
exit;0
